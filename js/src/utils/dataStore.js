...
dataStore.avengers = new AvengersCollection([
    ...
    },
    {
        ...
        description: 'Tony’s body had been enhanced by the modified techno-organic virus, Extremis, but it is currently inaccessible and inoperable. Tony has a genius level intellect that allows him to invent a wide range of sophisticated devices, specializing in advanced weapons and armor. He possesses a keen business mind.',
    },
    {
        id: 'captain-america',
        alias: 'Captain America',
        real_name: 'Steve Rodgers',
        description: 'Captain America represented the pinnacle of human physical perfection. He experienced a time when he was augmented to superhuman levels, but generally performed just below superhuman levels for most of his career. Captain America had a very high intelligence as well as agility, strength, speed, endurance, and reaction time superior to any Olympic athlete who ever competed. The Super-Soldier formula that he had metabolized had enhanced all of his bodily functions to the peak of human efficiency.',
    },
    {
        id: 'hawkeye',
        alias: 'Hawkeye',
        real_name: 'Clint Barton',
        description: 'Ronin is a world-class archer and marksman. His above average reflexes and hand-eye-coordination make him the most proficient archer ever known. He is also trained to throw knifes, darts, balls, bolas and boomerangs. He is natural athlete. He is also formidable unarmed combatant, thanks largely for longtime combat training with Captain America. He also has extensive training as an acrobat and aerialist. He is highly capable and charismatic team leader and a shrewd combat strategist, albeit sometimes reckless.',
    },
    {
        id: 'black-widow',
        alias: 'Black Widow',
        real_name: 'Natasha Romanova',
        description: 'Born circa 1928, Natasha was apparently orphaned as a child when she was trapped in a burning building during an early attack on Stalingrad by enemy forces. Ivan Petrovitch Bezukhov, a Soviet soldier, found Natasha in the inferno and rescued her. Although Ivan kept a close eye on Natasha as she grew, by the late 1930s she had attracted the attention of Soviet intelligence, which began her training. In 1941, she was almost brainwashed into serving the ninja clan the Hand, but was saved by Ivan.',
    }
], { parse: true });
